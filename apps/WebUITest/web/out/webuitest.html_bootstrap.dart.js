...
$$._ExpressionObserver = {"": "Object;_id<,_expression,_callback,_debugName,_reads,_unobservers,_scheduled@,_liblib1$_value",
  ...
  _observeValue$0: function() {
    var value = this._liblib1$_value;
    return;
...
$.init_autogenerated = function() {
  var _root, __t, t1, __e2, __binding1;
  _root = $.get$body$x(document);
  __t = $.Template$(_root);
  t1 = $.getInterceptor$x(_root);
  __t.listen$2($.get$onClick$x(t1.query$1(_root, "#__e-0")), new $.init_autogenerated_anon());
  __e2 = t1.query$1(_root, "#__e-2");
  __binding1 = __t.contentBind$2(new $.init_autogenerated_anon0(), false);
  t1 = $.get$nodes$x(__e2);
  t1.addAll$1(t1, [document.createTextNode("(click count: "), __binding1, document.createTextNode(")")]);
  __t.create$0();
  __t.insert$0(__t);
};
...
//@ sourceMappingURL=webuitest.html_bootstrap.dart.js.map
